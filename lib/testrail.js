...
var TestRail = (function () {
    function TestRail(options, reporter) {
        ...
        this.publishTestResults = function (run, results, testResults, options) { return __awaiter(_this, void 0, void 0, function () {
            var payload, runId, results_1, tests, _loop_1, this_1, testResults_1, testResults_1_1, testResult, e_1_1, error_5;
            var e_1, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        tests = _b.sent();
                        if (!options.uploadScreenshots) return [3, 11];
                        _loop_1 = function (testResult) {
                            var test, result, _a, _b, screenshot, e_2_1;
                            var e_2, _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        test = tests.find(function (test) { return test.case_id === testResult.caseId; });
                                        result = results_1.find(function (result) { return result.test_id === (test === null || test === void 0 ? void 0 : test.id); });
                                        if (!result) return [3, 8];
                                        _d.label = 1;
                                    case 1:
                                        _d.trys.push([1, 6, 7, 8]);
                                        _a = (e_2 = void 0, __values(testResult.testRunInfo.screenshots)), _b = _a.next();
                                        _d.label = 2;
                                    case 2:
                                        if (!!_b.done) return [3, 5];
                                        screenshot = _b.value;
                                        return [4, this_1.addAttachmentToResult(result.id, screenshot.screenshotPath)];
                                    case 3:
                                        _d.sent();
                                        _d.label = 4;
                                    case 4:
                    ...
                    case 4:
                        ...
                        testResults_1 = __values(testResults), testResults_1_1 = testResults_1.next();
                        _b.label = 5;
                    case 5:
                        if (!!testResults_1_1.done) return [3, 8];
                        testResult = testResults_1_1.value;
                        return [5, _loop_1(testResult)];
                    case 6:
                        _b.sent();
                        _b.label = 7;
                    case 7:
                        testResults_1_1 = testResults_1.next();
                        return [3, 5];
                    case 8: return [3, 11];
                    case 9:
                        e_1_1 = _b.sent();
        ...
        this.addAttachmentToResult = function (result_id, filePath) { return __awaiter(_this, void 0, void 0, function () {
            var url, fd, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.host + this.baseUrl + "add_attachment_to_result/" + result_id;
                        fd = new form_data_1.default();
                        fd.append("attachment", fs_1.default.createReadStream(filePath));
