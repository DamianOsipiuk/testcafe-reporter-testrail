...
| TESTRAIL_RUN_CREATED_MANUALLY | runCreatedManually | Tells to the reporting tool to no create or update the given test run, you need to create the mapping for the testcases manually                                                                                                                                                                                       |           `false`           |          |
